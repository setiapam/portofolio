<template>
    <EditorContent>
        <div class="admin-page">
            <div class="file-comment">-- admin/experiences.md</div>
            <div class="blank-line">&nbsp;</div>

            <div class="split-view">
                <!-- Left: list -->
                <div class="list-pane">
                    <AdminDataTable title="Experiences" :rows="experiences ?? []" label-field="company"
                        date-field="start_date" :selected-id="editing?.id" @create="createNew" @select="selectItem"
                        @delete="deleteItem" />
                </div>
